...
async function ssChart(symbol, interval) {
  ...
  await page.evaluate(() => {
    const sourcesWrappers = document.querySelectorAll(
  ...
  await page
    .locator(".chart-container-border")
...
console.log(await ssChart("NASDAQ:AAPL", "1D"))
